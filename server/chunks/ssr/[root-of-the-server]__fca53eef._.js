        ...
        if (success && unlockedSubjectValue) {
            ...
            if (unlockedSubjectValue === 'all') {
                ...
                if (validSubject) {
                    ...
                    return false; // Invalid subject returned from service
                }
            }
...
const subjects = [
    {
        ...
        glowColor: 'shadow-emerald-500/50 border-emerald-500/50'
    },
    {
        id: 'math',
        name: 'Math',
        ...
        glowColor: 'shadow-sky-500/50 border-sky-500/50'
    },
    {
        id: 'social-studies',
        name: 'Social Studies',
        ...
        glowColor: 'shadow-amber-500/50 border-amber-500/50'
    }
];
...
function SubjectCard({ subject, isUnlocked, onUnlockSuccess }) {
    ...
    const CardContentWrapper = ({ children })=>{
        const commonProps = {
            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("w-full h-full p-0 transition-all duration-300 ease-in-out group", !isUnlocked && subject.color, isUnlocked && subject.glowColor, isUnlocked && "shadow-lg")
        };
        if (isUnlocked) {
...
function SubjectSelection() {
    ...
    const handleUnlockSuccess = ()=>{
        // Force a re-render by briefly navigating to the same page
        // This is a simple way to pick up the state change from the hook
        router.refresh();
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fca53eef._.js.map